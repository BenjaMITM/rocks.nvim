        ...
        if line == "< OK >" then
            ...
            acquire_buffer_lock(buffer, function()
                ...
                vim.api.nvim_buf_set_lines(buffer, 0, -1, true, {
                    ...
                    '        vim.fs.joinpath(rocks_config.rocks_path, "lib", "lua", "5.4", "?.dylib"),',
                    '        vim.fs.joinpath(rocks_config.rocks_path, "lib64", "lua", "5.4", "?.dylib"),',
                    '        vim.fs.joinpath(rocks_config.rocks_path, "lib", "lua", "5.4", "?.dll"),',
                    '        vim.fs.joinpath(rocks_config.rocks_path, "lib64", "lua", "5.4", "?.dll"),',
                    "    }",
                ...
                vim.fn.setreg('"', {
                    ...
                    'package.cpath = package.cpath .. ";" .. table.concat(luarocks_cpath, ";")',
                    "",
                    'vim.opt.runtimepath:append(vim.fs.joinpath(rocks_config.rocks_path, "lib", "luarocks", "rocks-5.4", "*", "*"))',
